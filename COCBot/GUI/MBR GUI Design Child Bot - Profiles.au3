...
Local $x = 20, $y = 25
	...
	$grpTrainingClose = GUICtrlCreateGroup("Training Settings", $x - 20, $y - 20, 440, 275)
		...
		$radRandomCoCOpen = GUICtrlCreateRadio("Random Close or Leave! ", $x + 81, $y + 110, -1, -1)
	        ...
	        $txtTrainLogoutMaxTime = GUICtrlCreateInput("15", $x + 172, $y + 141, 30, 18, BitOR($GUI_SS_DEFAULT_INPUT, $ES_CENTER, $ES_NUMBER))
	            GUICtrlSetTip(-1, $txtTip)
	            GUICtrlSetLimit(-1, 2)
	            GUICtrlSetState(-1, $GUI_ENABLE)
	        $lblTrainLogoutMaxTime= GUICtrlCreateLabel("Minutes", $x + 210, $y + 143, -1, -1)
